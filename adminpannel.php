...
$UPLOADSECTION = "UploadSection";
  ...
  $totalApplicantres = getTotalApply($connection);

  $count = mysqli_num_rows($totalApplicantres);

  $paymentPendingResult  =getpaymentpending($connection);
  $pendingcount = mysqli_num_rows($paymentPendingResult);
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="row justify-content-center h-100">
        ...
        <div class="col-sm-2 hidden-md-down" id="sidebar">
            ...
            <div class="sidebar-content">
                <ul class="sidebar-content-list">
                    <li>
                        <a href="adminpannel.php" class="active"><i class="fa fa-home"
        ...
        <div class="col-sm-10" id="main-content">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <div class="pendinga">
                        <h4 style="color: white; text-align: center;">Payment Pending</h4>
                        <h5 style="color: white; text-align: center;"><?php
                           echo $pendingcount;
                            ?></h5>
                    </div>
